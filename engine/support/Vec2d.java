	...
	public Vec2d(String str){
		...
		if (matcher.find()) {
			try {
				...
				throw new IllegalArgumentException("Could not parse the coordinates from the string: " + str, e);
			}
		} else {
			throw new IllegalArgumentException("String format is incorrect, should be of the form \"(x, y)\": " + str);
		}
